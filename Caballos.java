public class Caballos {
    ...
    public void verDatosCaballo() {
        System.out.println("El caballo se llama " + this.nombre + ", es de color " + this.color + " y tiene "
                + this.edad + ". Ha ganado " + this.carrerasGanadas + " y ha perdido " + this.carrerasPerdidas
                + ". Además tiene " + this.trofeos + " trofeos.");
    }
